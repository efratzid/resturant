"""
Django settings for restuarnt project.
...
SECRET_KEY = 'django-insecure-vq6!g2y9%y!ka!h))@nnkd=3k055_!n+axqy*hxh0t@88c^vzr'
...
WSGI_APPLICATION = 'restuarnt.wsgi.application'
